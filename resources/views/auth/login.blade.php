...
<head>
    ...
    <title>Masuk Ke Akun — E-Library</title>
        ...
        <div class="bg-white rounded-[3rem] p-10 md:p-16 shadow-2xl shadow-indigo-100 border border-slate-100 relative overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <div class="text-center mb-12">
                    ...
                    <p class="text-lg text-slate-400 font-bold uppercase tracking-widest">Silakan Masuk Ke Akun Anda</p>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" required autofocus placeholder="nama@email.com" class="input-box">
                    </div>

                    <div>
                        <label class="block text-sm font-black text-slate-400 uppercase tracking-widest mb-2 ml-4">Kata Sandi</label>
                        <input type="password" name="password" required placeholder="••••••••" class="input-box">
                    </div>

                    <div class="flex items-center justify-between px-4">
                        <label class="flex items-center gap-2 cursor-pointer group">
                            <input type="checkbox" name="remember" class="w-5 h-5 rounded-lg border-2 border-slate-200 text-indigo-600 focus:ring-indigo-600">
                            <span class="text-sm font-bold text-slate-500 group-hover:text-slate-700 transition">Ingat Saya</span>
                        </label>
                        <a href="#" class="text-sm font-bold text-indigo-600 hover:underline">Lupa Sandi?</a>
                    </div>
                ...
                <div class="mt-12 text-center pt-8 border-t border-slate-50">
                    <p class="text-slate-400 font-bold">
                        Belum punya akun? 
                        <a href="{{ route('register') }}" class="text-indigo-600 hover:underline">Daftar Akun Baru</a>
                    </p>
                </div>
            </div>
        </div>
